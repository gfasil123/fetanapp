...
export default function DriverOrdersScreen({ navigation }) {
  ...
  // Filter to only show orders assigned to this driver
  const driverOrders = orders ? orders.filter(order => order.driverId === user?.id) : [];
        ...
        <View style={styles.emptyContainer}>
          ...
          {statusFilter !== 'all' ? (
            <Text style={styles.emptySubtext}>
              Try changing your filter to see your assigned orders with different statuses
            </Text>
          ) : (
            <Text style={styles.emptySubtext}>
